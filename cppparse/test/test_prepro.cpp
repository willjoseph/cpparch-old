	...
	struct char_traits: public _Char_traits_base
	{
		...
		static _Elem*_Copy_s(_Elem*_First1, size_t _Dest_size, const _Elem*_First2, size_t _Count)
		{

			{
				...
				{
					(void)((!!((("_Dest_size >= _Count", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\iosfwd", 212, 0, L"(\"_Dest_size >= _Count\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"_Dest_size >= _Count", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\iosfwd", 212, 0);
					return (0);
				}
			};
			_Elem*_Next=_First1;
		...
		static _Elem*_Move_s(_Elem*_First1, size_t _Dest_size, const _Elem*_First2, size_t _Count)
		{

			{
				if(!(_Dest_size>=_Count))
				{
					(void)((!!((("_Dest_size >= _Count", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\iosfwd", 242, 0, L"(\"_Dest_size >= _Count\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"_Dest_size >= _Count", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\iosfwd", 242, 0);
					return (0);
				}
			};
			_Elem*_Next=_First1;
...
namespace std
{
	...
	public:
		...
		void _Orphan_me()
		{
			if(_Mycont!=0&&_Mycont->_Myfirstiter!=((_Iterator_base*)-3))
			{
				...
				if(*_Pnext==0)_Debug_message(L"ITERATOR LIST CORRUPTED!", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 178);
				*_Pnext=_Mynextiter;
				_Mycont=0;
			}
		}
	...
	inline void _Debug_order2(_FwdIt _First, _FwdIt _Last, const wchar_t*_File, unsigned int _Line, forward_iterator_tag)
	{
		...
		++_Next!=_Last;
		++_First)if(_Debug_lt(*_Next, *_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1384))_Debug_message(L"sequence not ordered", _File, _Line);
	}
	template<class _InIt>
	...
	inline void _Debug_order2(_FwdIt _First, _FwdIt _Last, _Pr _Pred, const wchar_t*_File, unsigned int _Line, forward_iterator_tag)
	{
		if(_First!=_Last)for(_FwdIt _Next=_First;
		++_Next!=_Last;
		++_First)if(_Debug_lt_pred(_Pred, *_Next, *_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1411))_Debug_message(L"sequence not ordered", _File, _Line);
	}
	template<class _InIt, class _Pr>
	...
	inline void _Debug_order_single2(_FwdIt _First, _FwdIt _Last, bool _IsFirstIteration, const wchar_t*_File, unsigned int _Line, forward_iterator_tag)
	{
		...
		{
			_FwdIt _Next=_First;
			if(++_Next!=_Last)if(_Debug_lt(*_Next, *_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1440))_Debug_message(L"sequence not ordered", _File, _Line);
		}
	}
	template<class _InIt>
	...
	inline void _Debug_order_single2(_FwdIt _First, _FwdIt _Last, _Pr _Pred, bool _IsFirstIteration, const wchar_t*_File, unsigned int _Line, forward_iterator_tag)
	{
		...
		{
			_FwdIt _Next=_First;
			if(++_Next!=_Last)if(_Debug_lt_pred(_Pred, *_Next, *_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1469))_Debug_message(L"sequence not ordered", _File, _Line);
		}
	}
	template<class _InIt, class _Pr>
	...
	inline void _Distance2(_RanIt _First, _RanIt _Last, _Diff&_Off, random_access_iterator_tag)
	{
		if(_First!=_Last)
		{
			_Debug_pointer(_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1642);
			_Debug_pointer(_Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 1643);
		}
		_Off+=_Last-_First;
	}
	template<class _InIt>
	...
	public:
		...
		_Elem operator*()const
		{
			...
			if(_Strbuf==0)_Debug_message(L"istreambuf_iterator is not dereferencable", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2074);
			return (_Val);
		}
		_Myt&operator++()
		{
			if(_Strbuf==0)_Debug_message(L"istreambuf_iterator is not incrementable", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2085);
			_Inc();
			return (*this);
		}
		_Myt operator++(int)
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2226);
		for(;
		_First!=_Last;
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2253);
		if(_First!=_Last)_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2255);
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2300);
		for(;
		_First!=_Last;
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2345);
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2372);
		if(_First!=_Last)_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2374);
		ptrdiff_t _Off=_Last-_First;
		_OutIt _Result=_Dest-_Off;
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2422);
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2471);
		if(_First1!=_Last1)_Debug_pointer(_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2473);
		for(;
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2537);
		if(_First1!=_Last1)_Debug_pointer(_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2539);
		_Debug_pointer(_Pred, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2540);
		for(;
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2610);
		if(_First1!=_Last1)_Debug_pointer(_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2612);
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2623);
		if(_First1!=_Last1)_Debug_pointer(_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2625);
		return (::memcmp(_First1, _First2, _Last1-_First1)==0);
	}
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2636);
		if(_First1!=_Last1)_Debug_pointer(_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2638);
		return (::memcmp(_First1, _First2, _Last1-_First1)==0);
	}
	template<class _InIt1, class _InIt2>
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2724);
		for(;
		_First!=_Last;
		++_First)*_First=_Val;
	}
	...
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2732);
		::memset(_First, _Val, _Last-_First);
	}
	inline void _Fill(signed char*_First, signed char*_Last, int _Val)
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2739);
		::memset(_First, _Val, _Last-_First);
	}
	inline void _Fill(unsigned char*_First, unsigned char*_Last, int _Val)
	{
		_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2747);
		::memset(_First, _Val, _Last-_First);
	}
	template<class _FwdIt, class _Ty>
	...
	{
		if(0<_Count)_Debug_pointer(_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2774);
		::memset(_First, _Val, _Count);
	}
	inline void _Fill_n(signed char*_First, size_t _Count, int _Val, _Range_checked_iterator_tag)
	{
		if(0<_Count)_Debug_pointer(_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2786);
		::memset(_First, _Val, _Count);
	}
	inline void _Fill_n(unsigned char*_First, size_t _Count, int _Val, _Range_checked_iterator_tag)
	{
		if(0<_Count)_Debug_pointer(_First, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2798);
		::memset(_First, _Val, _Count);
	}
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2849);
		_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2850);
		for(;
		_First1!=_Last1&&_First2!=_Last2;
		++_First1, ++_First2)if(_Debug_lt(*_First1, *_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2852))return (true);
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2871);
		_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2872);
	...
	{
		_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2900);
		_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2901);
		_Debug_pointer(_Pred, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2902);
		for(;
		_First1!=_Last1&&_First2!=_Last2;
		++_First1, ++_First2)if(_Debug_lt_pred(_Pred, *_First1, *_First2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2904))return (true);
	...
	{
		return (_Debug_lt(_Left, _Right, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2938)?_Right: _Left);
	}
	template<class _Ty, class _Pr>
	inline const _Ty&(max)(const _Ty&_Left, const _Ty&_Right, _Pr _Pred)
	{
		return (_Debug_lt_pred(_Pred, _Left, _Right, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2946)?_Right: _Left);
	}
	template<class _Ty>
	inline const _Ty&(min)(const _Ty&_Left, const _Ty&_Right)
	{
		return (_Debug_lt(_Right, _Left, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2953)?_Right: _Left);
	}
	template<class _Ty, class _Pr>
	inline const _Ty&(min)(const _Ty&_Left, const _Ty&_Right, _Pr _Pred)
	{
		return (_Debug_lt_pred(_Pred, _Right, _Left, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xutility", 2961)?_Right: _Left);
	}
}
namespace stdext
{
...
namespace std
{
	...
	public:
		...
		_String_const_iterator(pointer _Ptr, const _Container_base*_Pstring)
		{

			{
				...
				{
					(void)((!!((("_Pstring == NULL || _Ptr != NULL && ((_Mystring *)_Pstring)->_Myptr() <= _Ptr && _Ptr <= (((_Mystring *)_Pstring)->_Myptr() + ((_Mystring *)_Pstring)->_Mysize)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 72, 0, L"(\"_Pstring == NULL || _Ptr != NULL && ((_Mystring *)_Pstring)->_Myptr() <= _Ptr && _Ptr <= (((_Mystring *)_Pstring)->_Myptr() + ((_Mystring *)_Pstring)->_Mysize)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"invalid argument\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 72, 0);
				};
			};
		...
		reference operator*()const
		{
			if(this->_Mycont==0||_Myptr==0||_Myptr<((_Mystring*)this->_Mycont)->_Myptr()||((_Mystring*)this->_Mycont)->_Myptr()+((_Mystring*)this->_Mycont)->_Mysize<=_Myptr)
			{
				...
				{
					(void)((!!((("Standard C++ Libraries Out of Range", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 112, 0, L"(\"Standard C++ Libraries Out of Range\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 112, 0);
				};
			}
			return (*_Myptr);
		}
		...
		_Myt&operator++()
		{
			if(this->_Mycont!=((const _Container_base*)-2))
			{

				{
					if(!(this->_Mycont!=0))
					{
						(void)((!!((("this->_Mycont != NULL", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 134, 0, L"(\"this->_Mycont != NULL\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"invalid argument\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 134, 0);
					};
				};

				{
					...
					{
						(void)((!!((("_Myptr < (((_Mystring *)this->_Mycont)->_Myptr() + ((_Mystring *)this->_Mycont)->_Mysize)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 135, 0, L"(\"_Myptr < (((_Mystring *)this->_Mycont)->_Myptr() + ((_Mystring *)this->_Mycont)->_Mysize)\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 135, 0);
					};
				};
			}
			++_Myptr;
		...
		_Myt&operator--()
		{
			if(this->_Mycont!=((const _Container_base*)-2))
			{

				{
					if(!(this->_Mycont!=0))
					{
						(void)((!!((("this->_Mycont != NULL", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 152, 0, L"(\"this->_Mycont != NULL\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"invalid argument\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 152, 0);
					};
				};

				{
					...
					{
						(void)((!!((("_Myptr > ((_Mystring *)this->_Mycont)->_Myptr()", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 153, 0, L"(\"_Myptr > ((_Mystring *)this->_Mycont)->_Myptr()\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 153, 0);
					};
				};
			}
			--_Myptr;
		...
		_Myt&operator+=(difference_type _Off)
		{
			if(this->_Mycont!=((const _Container_base*)-2))
			{

				{
					if(!(this->_Mycont!=0))
					{
						(void)((!!((("this->_Mycont != NULL", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 170, 0, L"(\"this->_Mycont != NULL\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"invalid argument\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 170, 0);
					};
				};

				{
					...
					{
						(void)((!!((("_Myptr + _Off <= (((_Mystring *)this->_Mycont)->_Myptr() + ((_Mystring *)this->_Mycont)->_Mysize) && _Myptr + _Off >= ((_Mystring *)this->_Mycont)->_Myptr()", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 171, 0, L"(\"_Myptr + _Off <= (((_Mystring *)this->_Mycont)->_Myptr() + ((_Mystring *)this->_Mycont)->_Mysize) && _Myptr + _Off >= ((_Mystring *)this->_Mycont)->_Myptr()\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 171, 0);
					};
				};
			}
			_Myptr+=_Off;
		...
		void _Compat(const _Myt&_Right)const
		{
			...
			{
				_Debug_message(L"string iterators incompatible", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 271);

				{
					(void)((!!((("Standard C++ Libraries Invalid Argument", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 272, 0, L"(\"Standard C++ Libraries Invalid Argument\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"invalid argument\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 272, 0);
				};
			}
		}
		static void _Xlen()
	...
	public:
		...
		void _Construct(_It _First, _It _Last, forward_iterator_tag)
		{
			...
			{
				_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 819);
			}
			size_type _Count=0;
		...
		basic_string(const_pointer _First, const_pointer _Last): _Mybase()
		{
			if(this->_Myfirstiter!=((_Iterator_base*)-3))
			{
				_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 842);
			}
			_Tidy();
		...
		basic_string(const_iterator _First, const_iterator _Last): _Mybase()
		{
			if(this->_Myfirstiter!=((_Iterator_base*)-3))
			{
				_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 857);
			}
			_Tidy();
			if(_First!=_Last)assign(&*_First, _Last-_First);
		}
		...
		reference operator[](size_type _Off)
		{
			if(this->_Myfirstiter!=((_Iterator_base*)-3))
			{
				if(_Mysize<_Off)
				{
					_Debug_message(L"string subscript out of range", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1498);

					{
						(void)((!!((("Standard C++ Libraries Out of Range", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1499, 0, L"(\"Standard C++ Libraries Out of Range\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1499, 0);
					};
				}
			}
			return (_Myptr()[_Off]);
		...
		const_reference operator[](size_type _Off)const
		{
			if(this->_Myfirstiter!=((_Iterator_base*)-3))
			{
				if(_Mysize<_Off)
				{
					_Debug_message(L"string subscript out of range", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1518);

					{
						(void)((!!((("Standard C++ Libraries Out of Range", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1519, 0, L"(\"Standard C++ Libraries Out of Range\", 0)"))||(__debugbreak(), 0));
						::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1519, 0);
					};
				}
			}
			return (_Myptr()[_Off]);
		...
		{
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1652);
			if(_Mysize<_Off)_String_base::_Xran();
			if(_Mysize-_Off<_Count)_Count=_Mysize-_Off;
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1693);
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1729);
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1766);
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1797);
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1830);
			if(_Off<_Mysize)
			{
				const _Elem*const _Vptr=_Myptr()+_Mysize;
				for(const _Elem*_Uptr=_Myptr()+_Off;
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1861);
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 1923);
			if(_Mysize<_Off)_String_base::_Xran();
			if(_Mysize-_Off<_N0)_N0=_Mysize-_Off;
		...
		{
			_Debug_pointer(_Ptr, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xstring", 2013);
...
namespace std
{
	...
	public:
		...
		public:
			...
			void*operator new(size_t _Size)
			{
				return (operator new(_Size, std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 144));
			}
		...
		locale&_Addfac(facet*_Fac, size_t _Id, size_t _Catmask)
		{
			...
			{
				this->_Ptr->_Decref();
				this->_Ptr=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 256)_Locimp(*this->_Ptr);
			}
		...
		locale combine(const locale&_Loc)const
		{
			...
			_Locimp*_Newimp=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 289)_Locimp(*_Ptr);
		...
		template<class _Facet>
		locale(const locale&_Loc, const _Facet*_Facptr): _Ptr(new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 298)_Locimp(*_Loc._Ptr))
		{
			if(_Facptr!=0)
			{
		...
		locale(const locale&_Loc, const locale&_Other, category _Cat): _Ptr(new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 327)_Locimp(*_Loc._Ptr))
		{
			try
			{
		...
		explicit locale(const char*_Locname, category _Cat=all): _Ptr(new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 342)_Locimp)
		{
			try
			{
				_Init();
		...
		locale(const locale&_Loc, const char*_Locname, category _Cat): _Ptr(new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 359)_Locimp(*_Loc._Ptr))
		{
			try
			{
	...
	inline _Elem*_Maklocstr(const char*_Ptr, _Elem*, const _Locinfo::_Cvtvec&)
	{
		...
		_Elem*_Ptrdest=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 609)_Elem[_Count];
	...
	inline wchar_t*_Maklocstr(const char*_Ptr, wchar_t*, const _Locinfo::_Cvtvec&_Cvt)
	{
		...
		++_Wchars;
		wchar_t*_Ptrdest=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 638)wchar_t[_Wchars];
	...
	public:
		...
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 764)codecvt<_Elem, _Byte, _Statype>;
			return (2);
		}
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 880)codecvt<_Elem, _Byte, _Statype>;
			return (2);
		}
		protected: virtual~codecvt()
		{
		...
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 899);
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 900);
			_Mid1=_First1, _Mid2=_First2;
		...
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 935);
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 936);
			_Mid1=_First1, _Mid2=_First2;
			result _Ans=_Mid1==_Last1?ok: partial;
			int _Bytes;
		...
		{
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 973);
			_Mid2=_First2;
			result _Ans=ok;
			int _Bytes;
			_Byte _Buf[5];
		...
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 998);
			int _Wchars;
			const _Byte*_Mid1;
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1118)codecvt<_Elem, _Byte, _Statype>;
			return (2);
		}
		protected: virtual~codecvt()
		{
		...
		virtual result do_in(_Statype&_State, const _Byte*_First1, const _Byte*_Last1, const _Byte*&_Mid1, _Elem*_First2, _Elem*_Last2, _Elem*&_Mid2)const
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1145);
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1146);
			_Mid1=_First1, _Mid2=_First2;
			result _Ans=_Mid1==_Last1?ok: partial;
			int _Bytes;
		...
		virtual result do_out(_Statype&_State, const _Elem*_First1, const _Elem*_Last1, const _Elem*&_Mid1, _Byte*_First2, _Byte*_Last2, _Byte*&_Mid2)const
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1181);
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1182);
			_Mid1=_First1, _Mid2=_First2;
			result _Ans=_Mid1==_Last1?ok: partial;
			int _Bytes;
			while(_Mid1!=_Last1&&_Mid2!=_Last2)if(5<=_Last2-_Mid2)if((_Bytes=_Wcrtomb(_Mid2, *_Mid1, &_State, &_Cvt))<0)return (error);
		...
		virtual result do_unshift(_Statype&_State, _Byte*_First2, _Byte*_Last2, _Byte*&_Mid2)const
		{
			_Debug_range(_First2, _Last2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1219);
			_Mid2=_First2;
			result _Ans=ok;
			int _Bytes;
			_Byte _Buf[5];
		...
		virtual int do_length(const _Statype&_State, const _Byte*_First1, const _Byte*_Last1, size_t _Count)const
		{
			_Debug_range(_First1, _Last1, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1244);
			int _Wchars;
			const _Byte*_Mid1;
			_Statype _Mystate=_State;
			for(_Wchars=0, _Mid1=_First1;
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1460)ctype<_Elem>;
			return (2);
		}
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1486);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1487);
			for(;
			_First!=_Last;
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1496);
			for(;
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1505);
			for(;
			_First!=_Last&&is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1522);
			for(;
			_First!=_Last;
			++_First)
			{
		...
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1543);
			for(;
			_First!=_Last;
			++_First)
			{
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1569);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1570);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1571, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1571, 0);
				}
			};
			for(;
			_First!=_Last;
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1606);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1607);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1608, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1608, 0);
				}
			};
			for(;
			_First!=_Last;
	...
	public:
		...
		const _Elem*is(const _Elem*_First, const _Elem*_Last, mask*_Dest)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1641);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1642);
			for(;
			_First!=_Last;
		...
		const _Elem*scan_is(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1651);
			for(;
			_First!=_Last&&!is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		const _Elem*scan_not(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1660);
			for(;
			_First!=_Last&&is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1763)ctype<_Elem>;
			return (2);
		}
		...
		virtual const _Elem*do_tolower(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1797);
			for(;
			_First!=_Last;
		...
		virtual const _Elem*do_toupper(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1811);
			for(;
			_First!=_Last;
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1833);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1834);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1835, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1835, 0);
				}
			};
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1858);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1859);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1860, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 1860, 0);
				}
			};
			::memcpy_s((_Dest), (_Dest_size), (_First), (_Last-_First));
			return (_Last);
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2002)ctype<_Elem>;
			return (2);
		}
		protected: virtual~ctype()
		{
		...
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2028);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2029);
			return (::_Getwctypes(_First, _Last, _Dest, &_Ctype));
		}
		virtual const _Elem*do_scan_is(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2036);
			for(;
			_First!=_Last&&!is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		virtual const _Elem*do_scan_not(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2045);
			for(;
			_First!=_Last&&is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		virtual const _Elem*do_tolower(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2059);
			for(;
			_First!=_Last;
		...
		virtual const _Elem*do_toupper(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2073);
			for(;
			_First!=_Last;
		...
		virtual const char*_Do_widen_s(const char*_First, const char*_Last, _Elem*_Dest, size_t _Dest_size)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2103);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2104);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2105, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2105, 0);
				}
			};
			for(;
			_First!=_Last;
		...
		virtual const _Elem*_Do_narrow_s(const _Elem*_First, const _Elem*_Last, char _Dflt, char*_Dest, size_t _Dest_size)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2138);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2139);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2140, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2140, 0);
				}
			};
			for(;
			_First!=_Last;
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2274)ctype<_Elem>;
			return (2);
		}
		protected: virtual~ctype()
		{
		...
		virtual const _Elem*do_is(const _Elem*_First, const _Elem*_Last, mask*_Dest)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2308);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2309);
			return ((const _Elem*)::_Getwctypes((const wchar_t*)_First, (const wchar_t*)_Last, _Dest, &_Ctype));
		}
		virtual const _Elem*do_scan_is(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2317);
			for(;
			_First!=_Last&&!is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		virtual const _Elem*do_scan_not(mask _Maskval, const _Elem*_First, const _Elem*_Last)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2326);
			for(;
			_First!=_Last&&is(_Maskval, *_First);
			++_First);
			return (_First);
		...
		virtual const _Elem*do_tolower(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2340);
			for(;
			_First!=_Last;
			++_First)*_First=_Towlower(*_First, &_Ctype);
			return ((const _Elem*)_First);
		...
		virtual const _Elem*do_toupper(_Elem*_First, const _Elem*_Last)const
		{
			_Debug_range((const _Elem*)_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2354);
			for(;
			_First!=_Last;
			++_First)*_First=_Towupper(*_First, &_Ctype);
			return ((const _Elem*)_First);
		...
		virtual const char*_Do_widen_s(const char*_First, const char*_Last, _Elem*_Dest, size_t _Dest_size)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2384);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2385);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2386, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2386, 0);
				}
			};
			for(;
			_First!=_Last;
		...
		virtual const _Elem*_Do_narrow_s(const _Elem*_First, const _Elem*_Last, char _Dflt, char*_Dest, size_t _Dest_size)const
		{
			_Debug_range(_First, _Last, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2418);
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2419);

			{
				if(!(_Dest_size>=(size_t)(_Last-_First)))
				{
					(void)((!!((("_Dest_size >= (size_t)(_Last - _First)", 0))))||(1!=_CrtDbgReportW(2, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2420, 0, L"(\"_Dest_size >= (size_t)(_Last - _First)\", 0)"))||(__debugbreak(), 0));
					::_invalid_parameter(L"\"out of range\"", L"<function-sig>", L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocale", 2420, 0);
				}
			};
			for(;
			_First!=_Last;
...
namespace std
{
	...
	class basic_streambuf
	{
		...
		protected: basic_streambuf(): _Plocale(new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\streambuf", 28)(locale))
		{
			_Init();
		}
...
namespace std
{
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 103)numpunct<_Elem>;
			return (4);
		}
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 222)num_get<_Elem, _InIt>;
			return (4);
		}
		static locale::id id;
	...
	public:
		...
		static size_t _Getcat(const locale::facet**_Ppf=0)
		{
			if(_Ppf!=0&&*_Ppf==0)*_Ppf=new(std::_DebugHeapTag_func(), "C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 840)num_put<_Elem, _OutIt>;
			return (4);
		}
		static locale::id id;
	...
	public:
		...
		{
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 931);
	...
	private:
		...
		{
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 1119);
			const _Mypunct&_Punct_fac=use_facet<_Mypunct>(_Iosbase.getloc());
			const string _Grouping=_Punct_fac.grouping();
			const _Elem _Kseparator=_Punct_fac.thousands_sep();
			string _Groupstring;
		...
		{
			_Debug_pointer(_Dest, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\xlocnum", 1264);
			const _Mypunct&_Punct_fac=use_facet<_Mypunct>(_Iosbase.getloc());
			const string _Grouping=_Punct_fac.grouping();
...
namespace std
{
	...
	public:
		...
		{
			_Debug_pointer(_Pfn, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\ostream", 170);
			return ((*_Pfn)(*this));
		}
		...
		{
			_Debug_pointer(_Pfn, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\ostream", 183);
			(*_Pfn)(*(ios_base*)this);
			return (*this);
		}
		...
		{
			_Debug_pointer(_Str, L"C:\\Program Files\\Microsoft Visual Studio 8\\VC\\include\\ostream", 528);
			ios_base::iostate _State=ios_base::goodbit;
			const sentry _Ok(*this);
			if(!_Ok)_State|=ios_base::badbit;
			else
