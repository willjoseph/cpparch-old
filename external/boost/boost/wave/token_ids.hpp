...
// import is needed to be a keyword for the C++ module Standards proposal
	...
	T_HAS_NOTHROW_CONSTRUCTOR = TOKEN_FROM_ID(422, KeywordTokenType),
	T_HAS_NOTHROW_COPY = TOKEN_FROM_ID(423, KeywordTokenType),
	T_HAS_TRIVIAL_ASSIGN = TOKEN_FROM_ID(424, KeywordTokenType),
	T_HAS_TRIVIAL_CONSTRUCTOR = TOKEN_FROM_ID(425, KeywordTokenType),
	T_HAS_TRIVIAL_COPY = TOKEN_FROM_ID(426, KeywordTokenType),
	T_HAS_TRIVIAL_DESTRUCTOR = TOKEN_FROM_ID(427, KeywordTokenType),
	T_HAS_VIRTUAL_DESTRUCTOR = TOKEN_FROM_ID(428, KeywordTokenType),
	T_IS_ABSTRACT = TOKEN_FROM_ID(429, KeywordTokenType),
	T_IS_BASE_OF = TOKEN_FROM_ID(430, KeywordTokenType),
	T_IS_CLASS = TOKEN_FROM_ID(431, KeywordTokenType),
	T_IS_CONVERTIBLE_TO = TOKEN_FROM_ID(432, KeywordTokenType),
	T_IS_EMPTY = TOKEN_FROM_ID(433, KeywordTokenType),
	T_IS_ENUM = TOKEN_FROM_ID(434, KeywordTokenType),
	T_IS_POD = TOKEN_FROM_ID(435, KeywordTokenType),
	T_IS_POLYMORPHIC = TOKEN_FROM_ID(436, KeywordTokenType),
	T_IS_UNION = TOKEN_FROM_ID(437, KeywordTokenType),
	T_IS_TRIVIAL = TOKEN_FROM_ID(438, KeywordTokenType),
	T_IS_TRIVIALLY_CONSTRUCTIBLE = TOKEN_FROM_ID(439, KeywordTokenType),
	T_IS_TRIVIALLY_ASSIGNABLE = TOKEN_FROM_ID(440, KeywordTokenType),
	T_IS_TRIVIALLY_COPYABLE = TOKEN_FROM_ID(441, KeywordTokenType),
	T_IS_STANDARD_LAYOUT = TOKEN_FROM_ID(442, KeywordTokenType),
